-- Migration: Ensure validation_status enum and columns exist
-- This is a safety net for migration 0003 which may not have been applied
-- by the Drizzle migrator (0000-0003 are excluded from the extra migrations runner)
...
-- Ensure element_audit_log table exists (also from 0003)
...
-- Ensure scoring_criteria table exists (also from 0003)
...
-- Ensure project_scores table exists (also from 0003)
