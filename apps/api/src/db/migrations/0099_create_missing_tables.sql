-- Migration 0099_create_missing_tables
-- Creates ALL 6 tables + 1 column reported missing by /api/health/db
-- Tables: scoring_criteria, element_definitions, element_rule_links,
--         rule_reference_links, guide_reference_tables, template_placeholder_mapping
-- Column: project_elements.element_def_id
...
-- ═══════════════════════════════════════════════════════
-- TABLE 1: scoring_criteria (selection criteria per guide)
-- FK deps: documents, organizations, users — all exist
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 1b: project_scores (computed per project per criteria)
-- FK deps: projects, scoring_criteria — both exist now
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 2: element_definitions (canonical field definitions from guide)
-- FK deps: documents, organizations — both exist
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 3: guide_reference_tables (structured data from annexes)
-- FK deps: documents, organizations, users — all exist
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 4: element_rule_links (links elements ↔ rules)
-- FK deps: template_elements, element_definitions, rules — all exist now
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 5: rule_reference_links (links rules ↔ reference tables)
-- FK deps: rules, guide_reference_tables — both exist now
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- TABLE 6: template_placeholder_mapping (template ↔ element_definitions)
-- FK deps: documents, element_definitions — both exist now
-- ═══════════════════════════════════════════════════════
...
-- FK to element_definitions(id) ON DELETE SET NULL
-- ═══════════════════════════════════════════════════════
