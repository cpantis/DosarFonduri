...
export const orgConfig = pgTable("org_config", {
  ...
  neemiaModel: varchar("neemia_model", { length: 100 }).default("claude-sonnet-4-6-20250514"),
  reguliFixeModel: varchar("reguli_fixe_model", { length: 100 }).default("claude-sonnet-4-6-20250514"),
