  ...
  return (
    <div className="animate-[fadeIn_.2s_ease-out]">
      <style>{`
        ...
        .cfg-select{border:1px solid rgba(226,232,240,.8);border-radius:8px;padding:8px 12px;font-size:14px;background:#ffffff;color:#0f172a;outline:none;cursor:pointer;font-family:'Inter', system-ui, sans-serif}
        .cfg-select:focus{border-color:#2563eb}
      `}</style>
