        ...
        <div className="flex-1 flex items-center justify-center" style={{ background: "#f8fafc" }}>
          {configError ? (
            <div className="text-center">
              <div className="text-sm mb-3" style={{ color: "#f87171" }}>{configError}</div>
              <button
            ...
            <div className="text-sm" style={{ color: "#94a3b8" }}>Se incarca...</div>
          )}
        </div>
      </>
    );
  ...
  return (
    <>
      <style>{`
        ...
        .cfg-nav-item.active{background:rgba(77,139,255,.08);color:#4d8bff;font-weight:600}
        ...
        .model-card.on{border-color:#4d8bff;background:rgba(77,139,255,.04)}
        ...
        .api-spinner{width:12px;height:12px;border:2px solid rgba(77,139,255,.3);border-top-color:#4d8bff;border-radius:50%;animation:spin .7s linear infinite;display:inline-block}
        ...
        .cfg-input{border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:14px;background:#ffffff;color:#0f172a;outline:none;font-family:'Inter', system-ui, sans-serif}
        .cfg-input:focus{border-color:#4d8bff}
        .cfg-input-mono{font-family:'JetBrains Mono', monospace}
        .cfg-select{border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:14px;background:#ffffff;color:#0f172a;outline:none;cursor:pointer;font-family:'Inter', system-ui, sans-serif}
        .cfg-select:focus{border-color:#4d8bff}
      `}</style>
      ...
      <div className="cfg-layout">
        ...
        <div className="cfg-content">
          ...
          {activeSection === "solomon" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>🤖 Solomon — Expert Fonduri Europene</div>
              ...
              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3 flex items-center gap-2" style={{ letterSpacing: ".8px", color: "#64748b" }}>
                  Model implicit
                </div>
                <div className="model-grid">
                  {AI_MODELS.map((m) => (
                    ...
                    >
                      ...
                      <div className="text-[11px] mb-0.5" style={{ color: "#94a3b8" }}>Viteza: {m.speed}</div>
                      <div className="text-[11px] mb-1.5 font-mono" style={{ color: "#64748b" }}>Cost: {m.cost}</div>
                      <div className="text-[11px] leading-snug" style={{ color: "#94a3b8" }}>{m.use}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="setting">
                <div className="flex-1">
                  <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Extended Thinking (ET)</div>
                  <div className="text-xs" style={{ color: "#94a3b8" }}>Activeaza rationament avansat pentru intrebari complexe de eligibilitate. Creste calitatea dar si costul si timpul de raspuns.</div>
                </div>
              ...
              <div className="p-3 mt-3 flex items-center gap-3 rounded-md" style={{ background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                <span className="text-xs flex-1" style={{ color: "#94a3b8" }}>Cost estimat per conversatie medie (15 mesaje):</span>
          ...
          {activeSection === "neemia" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>📝 Neemia — Expert Generare Dosar</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
              ...
              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".8px", color: "#64748b" }}>Model completare</div>
                <div className="model-grid">
              ...
              <div className="setting">
                <div className="flex-1">
                  <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Completare progresiva (SSE streaming)</div>
                  <div className="text-xs" style={{ color: "#94a3b8" }}>Afiseaza completarea pagina cu pagina in timp real. Dezactivat = completare batch, rezultat la final.</div>
                </div>
              ...
              <div className="setting">
                <div className="flex-1">
                  <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Validare automata elemente inainte de completare</div>
                  <div className="text-xs" style={{ color: "#94a3b8" }}>Neemia verifica daca toate elementele necesare sunt confirmate, valideaza consistenta datelor intre documente si se asigura ca dosarul respecta cerintele programului inainte de generare.</div>
                </div>
                <div className="toggle on"><div className="toggle-knob" /></div>
              </div>
            </>
          ...
          {activeSection === "ghid" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>📖 Ghid Finantare — Extragere Reguli</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
                Configureaza modelele AI pentru extragerea regulilor fixe si interpretate din ghidurile de finantare.
              </div>

              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".8px", color: "#64748b" }}>Reguli fixe (binar, verificabile)</div>
                <div className="setting">
                  <div className="flex-1">
                    <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Model extragere reguli fixe</div>
                    <div className="text-xs" style={{ color: "#94a3b8" }}>Dimensiuni minime, plafoane, categorii eligibile. ~25-30 reguli/ghid, precizie 92-97%.</div>
                  </div>
                  <select
              ...
              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".8px", color: "#64748b" }}>Reguli interpretate (context, arbori decizionali)</div>
                <div className="setting">
                  <div className="flex-1">
                    <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Model extragere reguli interpretate</div>
                    <div className="text-xs" style={{ color: "#94a3b8" }}>Intensitate sprijin, criterii selectie complexe. Precizie 75-85%, necesita validare umana.</div>
                  </div>
                  <select
                    className="cfg-select"
                    style={{ minWidth: 160 }}
                ...
                <div className="setting">
                  <div className="flex-1">
                    <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Extended Thinking pentru reguli interpretate</div>
                    <div className="text-xs" style={{ color: "#94a3b8" }}>Budget tokens: 8000-12000. Creste semnificativ calitatea pe arbori decizionali complexi.</div>
                  </div>
              ...
              <div className="setting">
                <div className="flex-1">
                  <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Prag auto-review consultant</div>
                  <div className="text-xs" style={{ color: "#94a3b8" }}>Regulile cu confidence sub acest prag sunt marcate automat pentru verificare umana.</div>
                </div>
              ...
              <div className="p-3 mt-3 flex items-center gap-3 rounded-md" style={{ background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                <span className="text-xs flex-1" style={{ color: "#94a3b8" }}>Cost estimat procesare completa ghid (60 pag.):</span>
          ...
          {activeSection === "api" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>🔌 Integrare API</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
                  ...
                  <div key={api.id} className={`api-card ${!api.enabled ? "disabled" : ""}`}>
                    <div className="flex items-center gap-3 mb-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[11px] font-mono" style={{ color: "#94a3b8" }}>{api.url}</div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-2.5">
                      <div className="p-2 rounded-md" style={{ background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                        <div className="text-[10px] font-semibold uppercase mb-0.5" style={{ letterSpacing: ".5px", color: "#94a3b8" }}>API Key</div>
                        <div className="text-xs font-mono" style={{ color: "#64748b" }}>{api.apiKeyMasked || "—"}</div>
                      </div>
                      <div className="p-2 rounded-md" style={{ background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                        <div className="text-[10px] font-semibold uppercase mb-0.5" style={{ letterSpacing: ".5px", color: "#94a3b8" }}>Ultimul test</div>
                    ...
                    <div className="flex gap-1.5">
                      <button
                        ...
                        style={{ opacity: isTesting ? 0.6 : 1, border: "1px solid rgba(77,139,255,.3)", color: "#4d8bff" }}
                      ...
                      {deleteConfirmId === api.id ? (
                        <>
                          <span className="text-xs font-semibold" style={{ color: "#f87171" }}>Sigur stergi?</span>
                          <button
                            className="px-3 py-1.5 text-xs font-bold cursor-pointer rounded-md font-sans"
                            style={{ border: "1px solid #f87171", background: "rgba(248,113,113,.1)", color: "#f87171" }}
                        ...
                        <button
                          className="px-3.5 py-1.5 text-xs font-semibold flex items-center gap-1 cursor-pointer transition-all rounded-md bg-transparent font-sans"
                          style={{ border: "1px solid rgba(248,113,113,.25)", color: "#f87171" }}
              ...
              {!showAddApi ? (
                ...
                <div className="p-4 mt-2.5 rounded-[10px]" style={{ border: "1px dashed #e2e8f0", background: "#f8fafc" }}>
                  <div className="flex justify-between items-center mb-3">
                    <div className="text-[13px] font-bold" style={{ color: "#0f172a" }}>Adauga API nou</div>
                    <button
          ...
          {activeSection === "branding" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>🎨 Branding Documente</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="block text-[11px] uppercase tracking-wide font-medium mb-1" style={{ letterSpacing: ".7px", color: "#64748b" }}>Culoare principala (header tabele)</label>
                  <div className="flex gap-2 items-center">
                    <input
                      ...
                      style={{ border: "1px solid #e2e8f0", background: "transparent" }}
                    />
                    <input
                      className="cfg-input cfg-input-mono flex-1"
                      value={branding.primaryColor}
                ...
                <div>
                  <label className="block text-[11px] uppercase tracking-wide font-medium mb-1" style={{ letterSpacing: ".7px", color: "#64748b" }}>Culoare accent (badge-uri)</label>
                  <div className="flex gap-2 items-center">
                    <input
                      type="color"
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="block text-[11px] uppercase tracking-wide font-medium mb-1" style={{ letterSpacing: ".7px", color: "#64748b" }}>Font documente</label>
                  <select
                ...
                <div>
                  <label className="block text-[11px] uppercase tracking-wide font-medium mb-1" style={{ letterSpacing: ".7px", color: "#64748b" }}>Culoare evidentiare (randuri)</label>
                  <div className="flex gap-2 items-center">
                    <input
                      type="color"
              ...
              <div className="mb-6">
                <label className="block text-[11px] uppercase tracking-wide font-medium mb-1" style={{ letterSpacing: ".7px", color: "#64748b" }}>Text footer cabinet</label>
                <input
              ...
              <div className="flex gap-6 mb-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-[13px]" style={{ color: "#0f172a" }}>Logo pe documente de lucru</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span className="text-[13px]" style={{ color: "#0f172a" }}>Logo pe documente finale</span>
                </label>
              </div>

              {/* Preview */}
              <div className="mb-6 p-4 rounded-[10px]" style={{ border: "1px solid #e2e8f0", background: "#f8fafc" }}>
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".7px", color: "#64748b" }}>Previzualizare tabel</div>
                ...
                {branding.footerText && (
                  <div className="mt-3 text-[10px]" style={{ color: "#94a3b8", fontFamily: branding.fontFamily }}>{branding.footerText}</div>
                )}
              </div>
          ...
          {activeSection === "notificari" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>🔔 Notificari</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
                Configureaza cand si cum primesti notificari despre activitatea din proiecte.
              </div>

              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".8px", color: "#64748b" }}>Email</div>
                <div className="setting">
                  <div className="flex-1">
                    <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>Adresa expeditor</div>
                    <div className="text-xs" style={{ color: "#94a3b8" }}>Adresa de email de la care se trimit notificarile (via Resend).</div>
                  </div>
                  <input
                    className="cfg-input cfg-input-mono"
                    style={{ width: 260 }}
              ...
              <div className="mb-7">
                <div className="text-[11px] uppercase tracking-wide font-medium mb-3" style={{ letterSpacing: ".8px", color: "#64748b" }}>Evenimente</div>
                {[
                  ...
                  <div key={n.key} className="setting">
                    <div className="flex-1">
                      <div className="text-sm font-semibold mb-0.5" style={{ color: "#0f172a" }}>{n.label}</div>
          ...
          {activeSection === "export" && (
            <>
              <div className="text-lg font-semibold mb-1" style={{ color: "#0f172a" }}>📤 Export & Backup</div>
              <div className="text-sm mb-7 leading-relaxed" style={{ color: "#64748b" }}>
              ...
              <div className="export-grid">
                <div className="export-btn" onClick={() => handleExport("/api/export/projects", `dosarfonduri_projects_${new Date().toISOString().slice(0, 10)}.json`)}>
                  ...
                  <div className="text-[13px] font-semibold mb-0.5" style={{ color: "#0f172a" }}>Export toate proiectele</div>
                  <div className="text-[11px]" style={{ color: "#94a3b8" }}>JSON cu elemente, documente, template-uri completate</div>
                </div>
                <div className="export-btn" onClick={() => handleExport("/api/export/config", `dosarfonduri_config_${new Date().toISOString().slice(0, 10)}.json`)}>
                  ...
                  <div className="text-[13px] font-semibold mb-0.5" style={{ color: "#0f172a" }}>Export configurari</div>
                  <div className="text-[11px]" style={{ color: "#94a3b8" }}>JSON cu toate setarile curente</div>
                </div>
                <div className="export-btn" style={{ opacity: 0.5, cursor: "not-allowed" }}>
                  <div className="text-2xl mb-1.5">🗄</div>
                  <div className="text-[13px] font-semibold mb-0.5" style={{ color: "#0f172a" }}>Backup baza de date</div>
                  <div className="text-[11px]" style={{ color: "#94a3b8" }}>PostgreSQL dump (disponibil in curand)</div>
                </div>
                <div className="export-btn" onClick={() => handleExport("/api/export/activity", `dosarfonduri_activity_${new Date().toISOString().slice(0, 10)}.csv`)}>
                  <div className="text-2xl mb-1.5">📊</div>
                  <div className="text-[13px] font-semibold mb-0.5" style={{ color: "#0f172a" }}>Raport activitate</div>
                  <div className="text-[11px]" style={{ color: "#94a3b8" }}>CSV cu toate actiunile pe ultimele 30 zile</div>
                </div>
                <div className="export-btn" onClick={() => handleExport("/api/export/projects-csv", `dosarfonduri_proiecte_${new Date().toISOString().slice(0, 10)}.csv`)}>
                  <div className="text-2xl mb-1.5">📋</div>
                  <div className="text-[13px] font-semibold mb-0.5" style={{ color: "#0f172a" }}>Export proiecte CSV</div>
                  <div className="text-[11px]" style={{ color: "#94a3b8" }}>CSV cu toate proiectele, firme, elemente, deadline-uri</div>
                </div>
              </div>
            </>
          )}
