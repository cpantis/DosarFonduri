...
const AI_MODELS = [
  ...
  { id: "claude-sonnet-4-6", short: "sonnet", name: "Claude Sonnet", speed: "Mediu", cost: "~$0.04/apel", use: "Extragere date, reguli fixe, completare template", color: "#2563eb" },
            ...
            <>
              ...
              <div className="mb-7">
                ...
                <div className="setting">
                  ...
                  >
                    <option value="claude-sonnet-4-6">Sonnet (~$0.04, ~12s)</option>
