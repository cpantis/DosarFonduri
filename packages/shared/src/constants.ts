...
export const KNOWN_COMPANY_FIELDS: readonly CompanyFieldDef[] = [
  ...
  { key: "este_intreprindere_in_dificultate", label: "Intreprindere in dificultate", category: "solicitant", dataType: "enum", enumValues: ["da", "nu", "nu_se_aplica"], aliases: ["firma_in_dificultate", "in_dificultate", "intreprindere_in_dificultate"], description: "Conform Reg. 651/2014 art.2 pct.18 — capitaluri proprii < 50% capital social", autoPopulated: true },
  ...
  { key: "apartine_grup", label: "Apartine unui grup", category: "solicitant", dataType: "enum", enumValues: ["da", "nu"], aliases: ["intreprinderi_legate", "intreprinderi_partenere", "face_parte_din_grup", "are_firme_legate"], description: "Apartine unui grup de intreprinderi legate/partenere", autoPopulated: true },
  { key: "stare_fiscala_ok", label: "Stare fiscala OK", category: "solicitant", dataType: "enum", enumValues: ["da", "nu"], autoPopulated: true, aliases: ["stare_fiscala", "situatie_fiscala"], description: "Fara insolventa, dizolvare, lichidare, restrictii, radiere" },
  { key: "bilant_actualizat", label: "Bilant actualizat", category: "financiar", dataType: "enum", enumValues: ["da", "nu", "lipsa"], autoPopulated: true, aliases: ["bilant_la_zi", "situatii_financiare_actualizate"], description: "Bilantul este din ultimul exercitiu fiscal incheiat" },
  { key: "trend_cifra_afaceri_1an", label: "Trend CA 1 an", category: "financiar", dataType: "enum", enumValues: ["crestere", "scadere", "stabil"], autoPopulated: true, description: "Tendinta cifra de afaceri fata de anul anterior" },
  { key: "trend_cifra_afaceri_3ani", label: "Trend CA 3 ani", category: "financiar", dataType: "enum", enumValues: ["crestere", "scadere", "stabil"], autoPopulated: true, description: "Tendinta cifra de afaceri pe 3 ani" },
  { key: "ani_consecutivi_pierdere", label: "Ani consecutivi pierdere", category: "financiar", dataType: "number", autoPopulated: true, description: "Numarul de ani fiscali consecutivi cu pierdere neta" },
  { key: "de_minimis_verificat", label: "De minimis verificat", category: "solicitant", dataType: "enum", enumValues: ["da", "nu"], aliases: ["verificare_de_minimis", "cumul_de_minimis"], description: "S-a verificat cumulul ajutoarelor de minimis din ultimii 3 ani" },
