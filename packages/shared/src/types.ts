...
export type DocFileType = "pdf" | "docx" | "xlsx" | "doc";
export type DocStatus = "uploaded" | "processing" | "processed" | "error";
export type DocProcessingType = "ghid" | "template" | "reference" | "client_doc";
...
export type ElementSource = "onrc" | "solomon" | "manual" | "calculated" | "ghid";
